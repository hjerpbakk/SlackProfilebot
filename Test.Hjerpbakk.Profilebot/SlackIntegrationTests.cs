...
namespace Test.Hjerpbakk.Profilebot {
    public class SlackIntegrationTests {
        ...
        public async Task SendDirectMessage_ValidUserAndMessage_SendsMessage() {
            ...
            await slack.SlackIntegration.SendDirectMessage(UserId, Text);

            slack.Connection.Verify(c => c.JoinDirectMessageChannel(UserId));
        ...
        public async Task SendDirectMessage_NoText_Fails() {
            ...
            // ReSharper disable once PossibleNullReferenceException
            var exception = await Record.ExceptionAsync(() => slack.SlackIntegration.SendDirectMessage("UserId", null));
